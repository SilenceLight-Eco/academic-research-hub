...
(function () {
  ...
  function bindEvents() {
    ...
    $('#promptList').addEventListener('dblclick', function (event) { if (state.promptTrashOpen || event.target.closest('button, [data-prompt-id], [data-prompt-category]')) return; if (event.target === this || event.target.closest('[data-prompt-create]')) newPrompt(); });
