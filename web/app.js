...
(function () {
  ...
  function renderJournalTracker() {
    ...
    $('#trackerSubscriptions').innerHTML = subscriptions.length ? journalCategories.map(function (category) {
